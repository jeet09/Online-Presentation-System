		...
		<div class="left_block left">
			<div class="content">
				<a href='index.php'><img src='./img/home.png' width='50' height='50'></img></a>
					...
					{	 
						echo "<tr><td><a style='text-decoration:none' href='presentation.php?view=$row1[name_of_presentation]'><font face='courier new' size='4'>".$row1['name_of_presentation']."</font></a></tr></td>\n";
					}
					echo "</table></div></div>"
					?>
			</div>
		...
		<div class="right_block right">
			<div class="content">
				<?php
					...
					<table id='myTable' border='0'>\n
						<tr>\n
							<td><a href='index.php?create' style='text-decoration:none'><font size='4' face='courier new'>Create Presentation</font></a></td>\n
						</tr>\n
					</table>\n</div>\n</div>";
